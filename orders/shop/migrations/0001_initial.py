# Generated by Django 2.2.4 on 2019-09-15 08:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Контакт', to='shop.Contact', verbose_name='Контакт')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_name', models.FileField(blank=True, null=True, storage=django.core.files.storage.FileSystemStorage(location='/home/den/PycharmProjects/pd-diplom/orders/storage'), upload_to='', verbose_name='')),
        ...
        migrations.AddField(
            model_name='category',
            name='shops',
            field=models.ManyToManyField(blank='True', related_name='categories', to='shop.Shop', verbose_name='Маганзины'),
        ),
